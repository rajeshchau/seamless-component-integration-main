        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-4 sticky top-32">
            ...
            <p className="text-neutral-400 text-xl max-w-sm">
              Discover how leading companies are scaling their digital operations with ConvergeDigitals.
            </p>
          </div>
            ...
            {testimonials.slice(0, 4).map((item, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  ...
                  <div>
                    <p className="text-2xl md:text-3xl font-medium text-white leading-tight mb-8 group-hover:text-primary transition-colors duration-500">
                      "{item.text}"
                    </p>
                    <div className="flex flex-col">
                      <span className="text-white font-bold text-lg">{item.name}</span>
                      <span className="text-neutral-500 font-medium uppercase tracking-wider text-xs">{item.role}</span>
                    </div>
                  </div>
                </div>
              </motion.div>
